        ...
        {!isOpen ? (
          ...
          >
            ...
            <header className="relative w-full min-h-screen md:min-h-[92vh] flex flex-col items-center justify-center text-center px-4 pt-32 pb-24 bg-gradient-to-b from-[#FDFBF7] via-[#FAF7F2] to-[#FAF9F5] overflow-hidden">
              ...
              {/* Subtle uploaded image background watermark */}
              <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat pointer-events-none select-none opacity-[0.035]" 
                style={{ backgroundImage: `url(${locationCeremony})` }} 
              />
            ...
            <section className="relative overflow-hidden py-24 bg-[#FAF9F6]">
              <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat pointer-events-none select-none opacity-[0.035]" 
                style={{ backgroundImage: `url(${locationCeremony})` }} 
              />
