...
export default function DigitalEnvelope({ onOpened, isAudioEnabled, toggleAudio }: DigitalEnvelopeProps) {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden flex flex-col items-center justify-center bg-radial from-[#F1EFE9] via-[#E8E4D9] to-[#D5CFBE] px-4 font-sans selection:bg-sage-200">
        ...
        >
          ...
          >
            ...
            <div className="text-center font-serif text-[#4F5341] pointer-events-none">
              ...
              <h2 className="text-xl md:text-2xl tracking-wide font-medium">Torrence & Wilfred</h2>
              <div className="w-8 h-[1px] bg-sage-400 mx-auto my-3 opacity-40" />
              <p className="font-script text-2xl text-[#C5A059] italic mt-1">Saturday, Sep 26, 2026</p>
            </div>
          </motion.div>
