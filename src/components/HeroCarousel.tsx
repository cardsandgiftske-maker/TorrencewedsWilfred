    ...
    >
      ...
      <div className="relative w-full aspect-[16/10] sm:aspect-[16/9] md:aspect-[2.1/1] max-h-[380px] rounded-3xl overflow-hidden shadow-[0_12px_36px_rgba(74,79,63,0.12)] border border-[#E7DFD0] bg-[#FAF8F5]">
        <AnimatePresence initial={false} custom={direction} mode="wait">
          ...
          >
            {/* Blurred Background Layer (Prevents empty bars on sides/top) */}
            <img
            ...
            {/* Foreground Main Image Layer (Maintains exact aspect ratio without cropping) */}
    ...
    >
      ...
      <div className="relative w-full aspect-[16/10] sm:aspect-[16/9] md:aspect-[2.1/1] max-h-[380px] rounded-3xl overflow-hidden shadow-[0_12px_36px_rgba(74,79,63,0.12)] border border-[#E7DFD0] bg-[#FAF8F5]">
        ...
        <button
          ...
          onClick={handlePrev}
          aria-label="Previous Photo"
          className="absolute left-3 top-1/2 -translate-y-1/2 z-20 w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/80 hover:bg-white text-[#4A4F3F] hover:text-[#2A2E23] flex items-center justify-center backdrop-blur-md border border-white/60 shadow-sm transition transform hover:scale-105 active:scale-95 cursor-pointer"
        >
          <ChevronLeft className="w-5 h-5 -ml-0.5" />
        </button>
        ...
        <button
          ...
          onClick={handleNext}
          aria-label="Next Photo"
          className="absolute right-3 top-1/2 -translate-y-1/2 z-20 w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/80 hover:bg-white text-[#4A4F3F] hover:text-[#2A2E23] flex items-center justify-center backdrop-blur-md border border-white/60 shadow-sm transition transform hover:scale-105 active:scale-95 cursor-pointer"
        >
          <ChevronRight className="w-5 h-5 -mr-0.5" />
        </button>
