...
export default function RSVPForm({ onRSVPSubmitted }: RSVPFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.name.trim() || !formData.email.trim()) {
      setErrorMess("Please fill in your name and email address.");
      return;
    }
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-[#5D634E] max-w-sm mx-auto leading-relaxed">
                  {formData.attending 
                    ...
                    : `We are sorry you won't be able to celebrate with us, ${formData.name}. We appreciate your thoughtfulness and sweet notes.`
                  }
                </p>
              </div>
